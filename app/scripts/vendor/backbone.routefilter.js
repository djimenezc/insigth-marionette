        ...
        (function (Backbone, _) {
            ...
            _.extend(Backbone.Router.prototype, {
                ...
                route: function (route, name, callback) {
                    ...
                    // or the name argument of the route method invocation. This is what
                    ...
                    var wrappedCallback = _.bind(function () {
                        ...
                        // If the before callback fails during its execution (by returning)
                        ...
                        if (_.isFunction(this.after)) {
                            ...
                            // If the after filter is a single function, then call it with
